          ...
          {({ open }) => (
            <>
              <div className="flex flex-wrap items-center justify-between w-full lg:w-auto">
                <Link href="/">
                  <span className="flex items-center space-x-2 text-2xl font-medium text-customBlue dark:text-gray-100">
                    <span>
                      <Image
                        src="/img/logo.png"
                        alt="N"
                ...
                <Disclosure.Panel className="flex flex-wrap w-full my-5 lg:hidden">
                  <>
                    ...
                    <Link href="/" className="w-full px-6 py-2 mt-3 text-center text-white bg-customBlue rounded-md lg:ml-5">         
                        Login 
                    </Link>
                    <Link href="/" className="w-full px-6 py-2 mt-3 text-center text-white bg-customBlue rounded-md lg:ml-5">         
                        Signup 
